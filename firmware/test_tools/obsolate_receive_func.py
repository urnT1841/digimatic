...
# State_processから持ってきた
# 不要関数群なので必要なImportとかは元ファイルにある
# pylintさんがうるさいのでコメントアウトしておく


# def process_receive(bits_buffer=rx_buffer):
#     """
#         はじめのロジック
...
# def process_receive_t(bits_buffer=rx_buffer):
...
# def process_receive_busy2(bits_buffer=rx_buffer):
#     """
