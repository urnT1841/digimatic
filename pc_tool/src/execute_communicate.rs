...
//             Ok(data) => {
//                 // 受付完了！あとは窓口（handle_received_data）に丸投げ
//                 handle_received_data(&data, rx_wtr, m_wtr, &Some(tx.clone()))?;
//             }
...
//                     return Err(e);
//                 }
//                 eprintln!("[Warning] エラーが発生しましたが、続行します: {}", e);
//             }
//         }
//     }
// }
...
//             Ok(data) => {
//                 // nibble -> string frame
//                 let nibbles = parser::parse_bits(&data, bit_mode)?;
//                 let frame_str = parser::decode_frame(&nibbles)?;
